using Godot;
using Godot.Collections;           // Keep this for Godot-specific stuff
using System.Collections.Generic; // Already there, but make sure

// Optional: Add alias to avoid future ambiguity
using SysDict = System.Collections.Generic.Dictionary<TKey, TValue>; // if you want
...
namespace CyberRogueWars
{
	...
	public class PlayerData
	{
		...
		/// </summary>
		public System.Collections.Generic.Dictionary<UnitType, UnitStatModifiers> UnitBoosts 
	{ get; private set; } = new();
